...
trainDataPath = "./data/housePriceComp1/train.csv"
trainData = pd.read_csv(trainDataPath)

testDataPath = "./data/housePriceComp1/test.csv"
testData = pd.read_csv(testDataPath)

savePath = "./data/housePriceComp1"
...
preprocessor = ColumnTransformer(
    transformers=[
        ...
        ("cat", categorical_transformer, objCols),
    ]
)
...
output.to_csv(os.path.join(savePath, r"finalOutputXG.csv"), index=False)
